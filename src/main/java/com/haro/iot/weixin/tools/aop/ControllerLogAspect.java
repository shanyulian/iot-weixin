package com.haro.iot.weixin.tools.aop;
...
public class ControllerLogAspect {
    ...
    @Pointcut("within(com.haro.iot.weixin.tools..*.controller..*)")
    public void inController() {
    }

    @Pointcut("execution(public * com.haro.iot.weixin.tools..*.controller..*.*(..))")
